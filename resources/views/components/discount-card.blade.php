...
<div
    ...
    <div
        class="w-auto absolute text-center top-5 left-5 flex-col items-center justify-center rounded-2xl bg-button-light-orange p-2 drop-shadow-lg md:flex-row md:inline-flex">
